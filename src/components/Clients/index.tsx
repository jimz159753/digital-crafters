    ...
    return (
        <div className='clients'>
            ...
            <div className='flex justify-center items-center flex-col w-2/3'>
                <h1 className='text-[50px] tablet:text-center'>Our clients love us because our quality work.</h1>
                <p className='font-Questrial text-[28px] text-[#000000] text-opacity-50 tablet:text-center'>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un</p>
            </div>
        </div>
    )
}
