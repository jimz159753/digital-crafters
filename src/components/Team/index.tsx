    ...
    return (
        <div className='team'>
            <div className='text-center flex flex-col items-center'>
                ...
                <p className='font-Questrial text-[28px] text-[#000000] text-opacity-50 w-[60%]'>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto.</p>
            </div>
            <div className='flex flex-row gap-10 justify-center tablet:flex-wrap'>
